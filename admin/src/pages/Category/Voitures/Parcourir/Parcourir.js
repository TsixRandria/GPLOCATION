                            ...
                            <table className="table-auto w-full text-center whitespace-no-wrap">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <NavLink to={'/editer'}>
                                            <td className=" border-b-2 border-gray-200 px-4 py-3 text-center text-gray-900">éditer</td>
                                        </NavLink>
                                    ...
                                    <tr>
                                        ...
                                        <td className="border-t-2 border-gray-200 px-4 text-center">
                                            <input name="plan" type="checkbox" />
                                        </td>
                                        <NavLink to={'/editer'}>
                                    ...
                                    <tr>
                                        ...
                                        <td className="border-t-2 border-b-2 border-gray-200 px-4 text-center">
                                            <input name="plan" type="checkbox" />
                                        </td>
                                        <NavLink to={'/editer'}>
                                            <td className="border-t-2 border-b-2 border-gray-200 px-4 py-3 text-center text-gray-900">éditer</td>
